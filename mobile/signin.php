<?php
session_start();
$page_title = "Sign In | Kristen Byte Solutions";
$page_description = "";
...
?>
    ...
    <main class="pt-32 pb-24 relative overflow-hidden flex items-center justify-center min-h-fit">
        ...
        <div class="absolute top-0 left-0 w-full h-full overflow-hidden -z-10 opacity-30 pointer-events-none">
            <div class="absolute -top-[20%] -left-[10%] w-[50%] h-[50%] rounded-full bg-gradient-to-br from-emerald-200 to-transparent blur-3xl dark:from-emerald-900/30"></div>
            <div class="absolute bottom-[10%] -right-[10%] w-[60%] h-[60%] rounded-full bg-gradient-to-tl from-emerald-100 to-transparent blur-3xl dark:from-emerald-800/20"></div>
        </div>
        ...
        <div class="w-full max-w-md mx-auto px-6 relative z-10">
            <div class="bg-white dark:bg-surface-bright rounded-[2rem] p-8 md:p-10 shadow-2xl border border-gray-100 dark:border-white/5 transition-all">
                ...
                <div class="text-center mb-8">
                    <h2 class="text-3xl font-extrabold text-brandNavy dark:text-white font-serif mb-3 tracking-tight">Welcome Back</h2>
                    <p class="text-gray-500 dark:text-gray-400 text-sm">Sign in to your account to continue</p>
                </div>

                <!-- Social Login -->
                <div class="mb-8">
                    <p class="text-center text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wider mb-5">Sign in with Social Media</p>
                ...
                <div class="relative flex items-center justify-center mb-8">
                    ...
                    <span class="relative bg-white dark:bg-surface-bright px-4 text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wider">Or sign in with email</span>
                </div>
                ...
                <form action="login_action.php" method="POST" class="space-y-6">
                    ...
                    <div>
                        <div class="flex justify-between items-center mb-2">
                            <label for="password" class="block text-sm font-semibold text-brandNavy dark:text-gray-300">Password</label>
                            <a href="#" class="text-xs text-emerald-500 hover:text-emerald-600 font-semibold transition-colors">Forgot Password?</a>
                        </div>
                    ...
                    <button type="submit" class="w-full bg-brandNavy dark:bg-emerald-accent text-white dark:text-[#051310] py-4 rounded-xl font-bold text-sm uppercase tracking-wider hover:opacity-90 hover:scale-[1.02] active:scale-[0.98] transition-all shadow-lg mt-2">
                        Sign In
                    </button>
                </form>
                ...
                <p class="mt-8 text-center text-sm text-gray-500 dark:text-gray-400">
                    ...
                    <a href="signup.php" class="text-brandNavy dark:text-emerald-400 font-bold hover:underline underline-offset-4">Sign Up</a>
                </p>
